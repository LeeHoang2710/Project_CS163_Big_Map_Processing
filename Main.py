...
source = stopquery.searchByABC(stopId=449)
destination = stopquery.searchByABC(stopId=468)
print(source[0].name)
...
# shortest_path_to_all = bus_graph.dijkstra(source=stopquery.searchByABC(stopId=35), destination=stopquery.searchByABC(stopId=7277))
# print(shortest_path_to_all['path'])
# print(shortest_path_to_all['time'])
